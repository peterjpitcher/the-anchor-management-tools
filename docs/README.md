...
## Operations & Support
- [Friday manager report](./manager-weekly-report.md): the weekly insights email, its schedule, the cutover from the old report, the preview and preflight scripts, and delivery recovery.
