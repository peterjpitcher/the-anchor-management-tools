...
CREATE TABLE IF NOT EXISTS "public"."sunday_lunch_menu_items" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "sunday_lunch_menu_items_category_check" CHECK ((("category")::"text" = ANY ((ARRAY['main'::character varying, 'side'::character varying, 'extra'::character varying])::"text"[])))
);
...
CREATE TABLE IF NOT EXISTS "public"."table_booking_items" (
    ...
    "item_type" character varying(20) DEFAULT 'main'::character varying,
    ...
    CONSTRAINT "table_booking_items_item_type_check" CHECK ((("item_type")::"text" = ANY ((ARRAY['main'::character varying, 'side'::character varying, 'extra'::character varying])::"text"[]))),
...
ALTER TABLE ONLY "public"."table_combination_tables"
    ADD CONSTRAINT "table_combination_tables_table_id_fkey" FOREIGN KEY ("table_id") REFERENCES "public"."tables"("id") ON DELETE CASCADE;
...
CREATE POLICY "Admins manage table combinations" ON "public"."table_combinations" USING ("public"."user_has_permission"("auth"."uid"(), 'table_bookings'::"text", 'manage'::"text"));
...
CREATE POLICY "Managers can manage menu items" ON "public"."sunday_lunch_menu_items" USING ((EXISTS ( SELECT 1
   FROM ("public"."user_roles" "ur"
     JOIN "public"."roles" "r" ON (("ur"."role_id" = "r"."id")))
  WHERE (("ur"."user_id" = "auth"."uid"()) AND ("r"."name" = ANY (ARRAY['super_admin'::"text", 'manager'::"text"]))))));
...
CREATE POLICY "Managers can manage table combination tables" ON "public"."table_combination_tables" USING ((EXISTS ( SELECT 1
   FROM ("public"."user_roles" "ur"
     JOIN "public"."roles" "r" ON (("ur"."role_id" = "r"."id")))
  WHERE (("ur"."user_id" = "auth"."uid"()) AND ("r"."name" = ANY (ARRAY['super_admin'::"text", 'manager'::"text"]))))));
...
CREATE POLICY "Managers can manage table combinations" ON "public"."table_combinations" USING ((EXISTS ( SELECT 1
   FROM ("public"."user_roles" "ur"
     JOIN "public"."roles" "r" ON (("ur"."role_id" = "r"."id")))
  WHERE (("ur"."user_id" = "auth"."uid"()) AND ("r"."name" = ANY (ARRAY['super_admin'::"text", 'manager'::"text"]))))));
...
CREATE POLICY "Managers can manage table configuration" ON "public"."table_configuration" USING ("public"."user_has_permission"("auth"."uid"(), 'table_bookings'::"text", 'manage'::"text"));
...
CREATE POLICY "Staff can view all menu items" ON "public"."sunday_lunch_menu_items" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM ("public"."user_roles" "ur"
     JOIN "public"."roles" "r" ON (("ur"."role_id" = "r"."id")))
  WHERE (("ur"."user_id" = "auth"."uid"()) AND ("r"."name" = ANY (ARRAY['super_admin'::"text", 'manager'::"text", 'staff'::"text"]))))));
...
CREATE POLICY "Staff can view table combination tables" ON "public"."table_combination_tables" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM ("public"."user_roles" "ur"
     JOIN "public"."roles" "r" ON (("ur"."role_id" = "r"."id")))
  WHERE (("ur"."user_id" = "auth"."uid"()) AND ("r"."name" = ANY (ARRAY['super_admin'::"text", 'manager'::"text", 'staff'::"text"]))))));
...
CREATE POLICY "Staff can view table combinations" ON "public"."table_combinations" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM ("public"."user_roles" "ur"
     JOIN "public"."roles" "r" ON (("ur"."role_id" = "r"."id")))
  WHERE (("ur"."user_id" = "auth"."uid"()) AND ("r"."name" = ANY (ARRAY['super_admin'::"text", 'manager'::"text", 'staff'::"text"]))))));
...
CREATE POLICY "Staff can view table configuration" ON "public"."table_configuration" FOR SELECT USING ("public"."user_has_permission"("auth"."uid"(), 'table_bookings'::"text", 'view'::"text"));
...
CREATE POLICY "anon_read_customers_for_bookings" ON "public"."customers" FOR SELECT TO "anon" USING (("id" IN ( SELECT "pending_bookings"."customer_id"
   FROM "public"."pending_bookings"
  WHERE ("pending_bookings"."customer_id" IS NOT NULL))));



CREATE POLICY "anon_read_events_for_bookings" ON "public"."events" FOR SELECT TO "anon" USING (("id" IN ( SELECT "pending_bookings"."event_id"
   FROM "public"."pending_bookings")));
