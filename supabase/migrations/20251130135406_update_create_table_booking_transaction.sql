-- Migration file to update create_table_booking_transaction function

-- Drop the existing function
DROP FUNCTION IF EXISTS create_table_booking_transaction(JSONB, JSONB, JSONB);

-- Recreate the function with payment_method and payment_status
...
BEGIN
  ...
  INSERT INTO table_bookings (
    ...
    (p_booking_data->>'payment_method')::table_booking_payment_method,
