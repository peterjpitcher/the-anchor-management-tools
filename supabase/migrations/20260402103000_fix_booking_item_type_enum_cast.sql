-- Ensure create_table_booking_transaction casts item_type to booking_item_type enum
...
BEGIN
  ...
  INSERT INTO table_bookings (
    ...
    (p_booking_data->>'booking_type')::table_booking_type,
    ...
    COALESCE(p_booking_data->>'status', 'confirmed')::table_booking_status
  )
  ...
  IF jsonb_array_length(p_menu_items) > 0 THEN
    ...
    SELECT
      ...
      (item->>'item_type')::booking_item_type,
  ...
  IF p_payment_data IS NOT NULL THEN
    INSERT INTO table_booking_payments (
      ...
      (p_payment_data->>'status')::payment_status,
