-- Ensure create_private_booking_transaction never inserts NULL into customers.last_name
-- Some booking flows treat customer last name as optional, but customers.last_name is NOT NULL.
