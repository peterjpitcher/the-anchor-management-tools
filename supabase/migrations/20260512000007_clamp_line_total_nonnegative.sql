...
-- 1. Drop the view that depends on line_total (via get_booking_discounted_total)
...
-- 3. Recreate the private_bookings_with_details view
-- Copied from 20260512000001_add_date_tbd_column.sql (includes date_tbd column)
