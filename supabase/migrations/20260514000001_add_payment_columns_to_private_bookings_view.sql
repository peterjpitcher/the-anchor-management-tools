-- Add hold_expiry, total_balance_paid, balance_remaining, and payment_status
-- to the private_bookings_with_details view.
-- These columns are needed by the balance payment UI and booking detail pages.
--
-- Base definition matches the most recent view rebuild
-- (20260420000001_add_contract_note_to_private_bookings.sql) which added
-- end_time_next_day and contract_note. New columns appended after days_until_event.
