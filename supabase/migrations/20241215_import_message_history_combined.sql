-- Combined migration to import message history
-- Run this single file instead of the two separate files
...
BEGIN
  ...
  FOR rec IN SELECT * FROM temp_message_import LOOP
    ...
    IF cust_id IS NULL THEN
      skipped := skipped + 1;
      RAISE NOTICE 'Skipping message % - no customer found for phone %', 
        rec.sid, 
...
-- Now copy the data from 20241215_import_message_data.sql below this line
-- Then add these lines at the very end:
