-- Force update of create_private_booking_transaction to ensuring hold_expiry is included
-- Re-applying logic to ensure it runs on db push
-- Also includes NULLIF check for empty email strings to prevent constraint violations
-- FIXED: Removed line_total from INSERT as it is a generated column
