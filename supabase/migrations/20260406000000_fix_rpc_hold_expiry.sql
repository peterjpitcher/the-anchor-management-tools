-- Fix create_private_booking_transaction to include hold_expiry
-- Generated to resolve "Failed to create booking" error due to missing hold_expiry
...
BEGIN
  ...
  INSERT INTO private_bookings (
    ...
    (p_booking_data->>'hold_expiry')::TIMESTAMPTZ -- Added this value
  )
