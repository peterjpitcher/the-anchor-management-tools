...
export function VenueCalendar({
  ...
  const entries = useMemo(
    () => buildEntries(events, privateBookings, calendarNotes, parkingBookings),
    [events, privateBookings, calendarNotes, parkingBookings],
  )
  ...
  const legendKinds = useMemo<CalendarEntryKind[]>(() => {
    ...
    kinds.push('event')
    return kinds
  }, [calendarNotes.length, privateBookings.length, parkingBookings.length])
  ...
  }, [events, calendarNotes, privateBookings, parkingBookings])
