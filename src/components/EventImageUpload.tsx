      ...
      <form ref={formRef} action={formAction} className="space-y-4">
        ...
        {imageType === 'gallery' && (
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <label htmlFor={`alt_text_${imageType}`} className="block text-sm font-medium text-gray-700">
                Alt Text
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor={`caption_${imageType}`} className="block text-sm font-medium text-gray-700">
                Caption
              </label>
              <input
                type="text"
