...
// The pure arithmetic lives in ./pay-math so that CLIENT components can import
// it without dragging in @/lib/supabase/server. Everything there is re-exported
// here, so existing server-side importers of this module are unchanged.
// New client-side callers should import '@/lib/rota/pay-math' directly.
export * from './pay-math';
