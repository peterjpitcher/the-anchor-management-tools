...
export const mastheadGreen = defineBlock<MastheadGreenData>({
  ...
  sample: {},
  render: () =>
    `<tr><td bgcolor="${GUEST.green}" align="center" style="background-color:${GUEST.green};padding:28px 32px 22px"><img src="https://www.the-anchor.pub/images/branding/the-anchor-pub-logo-white-transparent.png" width="176" height="88" alt="The Anchor, Stanwell Moor Village" style="display:block;width:176px;height:88px;border:0;margin:0 auto"></td></tr>
<tr><td bgcolor="#003d25" align="center" style="background-color:#003d25;padding:10px 32px;font-family:'Outfit','Helvetica Neue',Helvetica,Arial,sans-serif;font-size:11px;font-weight:600;line-height:16px;mso-line-height-rule:exactly;letter-spacing:0.18em;text-transform:uppercase;color:${GUEST.goldBright}">Stanwell Moor Village &middot; Since 1751</td></tr>
`,
