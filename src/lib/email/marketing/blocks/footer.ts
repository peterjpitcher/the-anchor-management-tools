...
export const footer = defineBlock<FooterData>({
  ...
  render: (data) => {
    ...
    return `<tr><td bgcolor="${GUEST.sunk}" align="center" style="background-color:${GUEST.sunk};padding:30px 32px 34px">
<div style="font-family:'Outfit','Helvetica Neue',Helvetica,Arial,sans-serif;font-size:11px;font-weight:600;line-height:16px;letter-spacing:0.18em;text-transform:uppercase;color:${GUEST.accentText};padding-bottom:10px">Where everyone&rsquo;s welcome</div>
<div style="font-family:'Outfit','Helvetica Neue',Helvetica,Arial,sans-serif;font-size:13px;line-height:21px;color:${GUEST.textMuted}">The Anchor, Horton Road, Stanwell Moor, Surrey TW19 6AQ<br>01753 682707 &middot; <a href="https://www.the-anchor.pub" style="color:${GUEST.textMuted};text-decoration:underline">the-anchor.pub</a></div>
<div style="font-family:'Outfit','Helvetica Neue',Helvetica,Arial,sans-serif;font-size:13px;line-height:21px;color:${GUEST.textMuted};padding-top:12px"><a href="https://www.facebook.com/theanchorpubsm/" style="color:${GUEST.textMuted};text-decoration:underline">Facebook</a> &nbsp;&middot;&nbsp; <a href="https://www.instagram.com/theanchor.pub/" style="color:${GUEST.textMuted};text-decoration:underline">Instagram</a></div>
