...
<tr><td bgcolor="#faf8f3" class="gutter" style="background-color:#faf8f3;padding:8px 32px 0;font-family:'DM Serif Display',Georgia,'Times New Roman',serif;font-size:32px;font-weight:400;line-height:38px;mso-line-height-rule:exactly;letter-spacing:-0.02em;color:#005131">${escapeEmailText(data.heading)}</td></tr>
<tr><td bgcolor="#faf8f3" class="gutter" style="background-color:#faf8f3;padding:14px 32px 24px;font-family:'Outfit','Helvetica Neue',Helvetica,Arial,sans-serif;font-size:16px;line-height:27px;mso-line-height-rule:exactly;color:#1a1a1a">${escapeEmailText(data.body)}</td></tr>
`,
