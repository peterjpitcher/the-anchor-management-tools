...
<td width="112" valign="middle" align="right" style="width:112px;padding:16px 20px 16px 0;font-family:'Outfit','Helvetica Neue',Helvetica,Arial,sans-serif;font-size:14px;font-weight:600;line-height:22px"><a href="${escapeEmailUrl(data.url)}" style="color:#8b6914;text-decoration:none">Details &rarr;</a></td>
</tr>
</tbody></table></td></tr>
</tbody></table>`,
  text: (data) =>
