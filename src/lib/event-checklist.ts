...
export const EVENT_CHECKLIST_DEFINITIONS: EventChecklistDefinition[] = [
  ...
  { key: 'setup_opentable_experience', label: 'Setup OpenTable Experience', offsetDays: -28, channel: 'OpenTable', required: true, order: 2 },
  { key: 'publish_event_page', label: 'Build & publish event web page', offsetDays: -28, channel: 'Website', required: true, order: 3 },
  { key: 'create_short_link', label: 'Create short link & QR code', offsetDays: -28, channel: 'Website', required: true, order: 4 },
  { key: 'design_table_talkers', label: 'Design table-talkers', offsetDays: -28, channel: 'Print file', required: true, order: 5 },
  { key: 'design_bar_strut_cards', label: 'Design bar-strut cards', offsetDays: -28, channel: 'Print file', required: true, order: 6 },
  { key: 'design_poster', label: 'Design poster', offsetDays: -28, channel: 'Print file', required: false, order: 7 },
  { key: 'create_facebook_event', label: 'Create Facebook Event', offsetDays: -28, channel: 'Facebook', required: true, order: 8 },
  { key: 'add_google_business_post', label: 'Add Google Business Profile Event post', offsetDays: -28, channel: 'Google', required: true, order: 9 },
  { key: 'schedule_social_content', label: 'Create & schedule social content', offsetDays: -28, channel: 'FB/IG', required: true, order: 10 },
  { key: 'schedule_stories', label: 'Schedule Stories (day-before & day-of)', offsetDays: -28, channel: 'FB/IG', required: true, order: 11 },
