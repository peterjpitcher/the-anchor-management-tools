...
//
// Every row is sent immediately. The manager checklist alerts the weekly insights report
// covers (out-of-range readings, a closedown with nothing ticked, the weekly summary) are no
// longer written to this outbox. What remains is the owner's technical alerts, which must
// never wait, and the twice-yearly season reminder. Rows left 'held' by the old Friday report
// are not touched here (see docs/manager-weekly-report.md).
