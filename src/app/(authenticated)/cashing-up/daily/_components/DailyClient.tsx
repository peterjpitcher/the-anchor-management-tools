...
const compactAmountInputClass = `${numberInputNoSpinnerClass} h-8 min-h-touch py-1 text-xs sm:min-h-0`
              ...
              <div className="flex justify-between items-center pt-1.5 border-t border-border">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <Input
                    ...
                    onWheel={(e) => e.currentTarget.blur()}
                    className={`${numberInputNoSpinnerClass} h-7 min-h-touch sm:min-h-0 w-24 px-1 sm:p-0 text-right text-xs font-mono`}
                    disabled={fieldsDisabled}
                  />
                </div>
              </div>
          ...
          <CardBody className="space-y-3 p-3">
            ...
            <Field label="Notes / variance reason">
              <Input
                ...
                className="h-8 min-h-touch sm:min-h-0 py-1 text-xs"
                disabled={fieldsDisabled}
              />
            </Field>
