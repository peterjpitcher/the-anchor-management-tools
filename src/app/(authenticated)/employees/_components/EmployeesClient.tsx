          ...
          actions={
            <div className="flex items-center gap-2">
              {permissions.canExport && (
                <Dropdown
                  trigger={<Button variant="secondary" size="sm" icon={<DownloadIcon />}>Export</Button>}
                >
              ...
              {permissions.canCreate && (
                <>
                  <Button variant="secondary" size="sm" icon={<EnvelopeIcon />} onClick={() => setShowInviteModal(true)}>
                    Invite
                  </Button>
                  <Link href="/employees/new">
                    <Button variant="primary" size="sm" icon={<PlusIcon />}>Add employee</Button>
                  </Link>
                </>
              )}
              {canManageSettings && (
