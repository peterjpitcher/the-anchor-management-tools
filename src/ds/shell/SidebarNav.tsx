          ...
          {group.items.map((item) => {
            ...
            return (
              ...
              >
                ...
                {count ? (
                  <span
                    className="ds-label ds-nav-badge ml-auto inline-flex items-center justify-center h-5 min-w-5 px-1.5 rounded-full bg-sidebar-active-bg text-meta font-semibold text-text"
