...
export function Sidebar({ navGroups, userName, userRole, onSignOut, isSigningOut, onNavigate,
  ...
  return (
    <div className="ds-sidebar-rail relative hidden shell:block" data-pinned={pinned}>
      <div className="ds-sidebar flex h-full flex-col bg-sidebar-bg" data-expanded={open}
        ...
        <div className="ds-sidebar-brand flex h-8 shrink-0 items-center text-sidebar-fg">
          ...
          {onPinnedChange && (
            <button type="button" className="ds-label mr-2 grid h-6 w-6 place-items-center rounded hover:bg-sidebar-hover-bg"
        ...
        <button type="button" className="ds-nav-link shrink-0 rounded text-sidebar-fg-muted hover:bg-sidebar-hover-bg"
          ...
          <span className="ds-label text-[13px]">Find or go to...</span>
        </button>
