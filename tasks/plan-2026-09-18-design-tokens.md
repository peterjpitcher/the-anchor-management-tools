...
| PR-09 | Area: guest pages, sign-in, recruitment booking, invoice portal | [x] | see git log | dpl_9kCebfEJhZN8hPVWu9fKz3n6Mprv (c62529b9, wave 1 + PR-09), live 18 Sep 18:12 |
| PR-10 | Area: FOH, BOH, table bookings, vouchers, timeclock, kiosk, parking | [x] | see git log | dpl_9kCebfEJhZN8hPVWu9fKz3n6Mprv (c62529b9, wave 1 + PR-09), live 18 Sep 18:12 |
| PR-11 | Area: employee onboarding and staff portal | [x] | see git log | dpl_9kCebfEJhZN8hPVWu9fKz3n6Mprv (c62529b9, wave 1 + PR-09), live 18 Sep 18:12 |
| PR-12 | Area: private bookings, customers, events, messages, marketing, short links | [x] | 7c749014 (12b), 8d691f03 (12a), 0d9e0f40 (DS fields) | dpl_CuAM3NDaTB3xRHQcW5L8R1vuGBV8 (0d9e0f40), live 18 Sep 19:30 |
| PR-13 | Area: employees, roles, users, profile, rota, checklists, maintenance, recruitment | [x] | d062a260 (people), 19b8d8f1 (rota, with the rota and hours PDFs) | final push, see session log |
| PR-14 | Area: invoices, quotes, OJ projects, expenses, mileage, cashing up, receipts, MGD, dashboard | [x] | see git log | dpl_9kCebfEJhZN8hPVWu9fKz3n6Mprv (c62529b9, wave 1 + PR-09), live 18 Sep 18:12 |
| PR-15 | Area: settings and menu management | [x] | see git log | dpl_9kCebfEJhZN8hPVWu9fKz3n6Mprv (c62529b9, wave 1 + PR-09), live 18 Sep 18:12 |
| PR-16 | Brand colour module and staff emails | [x] | 608edae8 | dpl_GXV3oyo9mhn5vvggRGi4T9hXsZTi (6e6a8be0), live 18 Sep 19:10 |
| PR-17 | Guest emails | [x] | 7579d0b8 | dpl_GXV3oyo9mhn5vvggRGi4T9hXsZTi, live 18 Sep 19:10 |
| PR-18 | PDFs, printable HTML, `/auth/confirm`, shared category palette | [x] | 5fbb07b2, 6e6a8be0; rota and hours PDFs in 19b8d8f1 | dpl_GXV3oyo9mhn5vvggRGi4T9hXsZTi (documents); rota PDFs with the final push |
| PR-19 | Living style guide, standards docs, agent rules, tidy-up | [x] | see git log (docs: living style guide...) | final push, see session log |
...
- 2026-09-18 18:12: PR-09, PR-10, PR-11, PR-14, PR-15 live (c62529b9, dpl_9kCebfEJhZN8hPVWu9fKz3n6Mprv), confirmed on /auth/login. Wave 2 (PR-12a, PR-12b, PR-13) and PR-16, PR-17, PR-18a, PR-18b started as background agents in the worktree; palette.ts extended with STAFF, GUEST, CHART_SERIES (DOCUMENT_PALETTE kept as a STAFF subset for the receipt PDF).
- 2026-09-18 19:10: PR-16, PR-17 and the PR-18 documents live (6e6a8be0, dpl_GXV3oyo9mhn5vvggRGi4T9hXsZTi); /auth/confirm checked live (stone page, brand button). Gates ran in a clean detached worktree ../OJ-AMS-dt-gate at the commit (lint, tsc, 9,183 tests x2, cold build) because the main worktree held reviewers' uncommitted edits. Each wave 2 area had an independent reviewer (12a: completed neutral per D4, send button flush, two contrast fixes; 12b: swatch focus ring). Drafts are amber (a hold waiting for its deposit = pending payment, D4); live data 33 confirmed, 18 completed, 14 cancelled, 4 draft, no tentative, so the calendar legend drops Tentative. DS Input/Select/Textarea now set text-text (white-on-white inside light-on-dark layouts). PDF status badges take invoiceStatusTone/quoteStatusTone. palette.ts gains CATEGORY (cat-1..8) for the rota PDF.
- 2026-09-18 19:45: PR-12 live (0d9e0f40, dpl_CuAM3NDaTB3xRHQcW5L8R1vuGBV8). PR-13 people (d062a260) and rota (19b8d8f1) committed after independent reviews: people found no defects (tabs now wrap at desktop, ProgressBar takes a label, Alert takes role=status); rota fixed four defects (printed rota called every non-bar shift Kitchen, unescaped names in the PDF HTML, Sick vs Couldn't Work, payroll row actions hidden from keyboard) and made screen and print share resolveShiftColour, one department to category map (ROTA_DEPARTMENT_CATEGORIES) and one hours series list. PR-19: style guide reads live tokens, UI_UX.md rewritten, agent and CLAUDE.md updated, audit-results.json deleted, lesson added. Out-of-scope bugs found on the way were raised as separate suggested tasks (employee More menu on phones, two employee date bugs, customer insights growth, localhost fallbacks, SeasonalPeriods 10-plus wording, accessibility gaps, SpecialHoursCalendar default prop).
