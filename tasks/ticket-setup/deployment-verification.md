...
Both approved migrations were applied to production project `tfcasgxopxegwrabvwat` on 10 September 2026. Approved contents are retained. Later the same day the files were renamed from `20260910065400_…` and `20260910073920_…` to the versions production recorded, so `supabase db push` no longer sees them as pending. The SHA-256 values below are unchanged.

| Repository migration | Production history version | SHA-256 |
| --- | --- | --- |
| `20260910075712_ticket_setup_and_attendees.sql` | `20260910075712` | `3c932cde7891ed338c8fcd548343b285d96d0ce804d6db84d002c8b1ab28ee21` |
| `20260910075719_ticket_attendees_dining_requests.sql` | `20260910075719` | `70d663e10124565c2900d592d2e57f424cecf80b9d772ca7e57ae84db79fbca8` |
