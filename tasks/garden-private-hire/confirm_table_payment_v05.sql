CREATE OR REPLACE FUNCTION public.confirm_table_payment_v05(p_table_booking_id uuid, p_checkout_session_id text, p_payment_intent_id text, p_amount numeric, p_currency text DEFAULT 'GBP'::text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
