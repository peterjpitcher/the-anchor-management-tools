...
/**
 * Seed a single menu ingredient + price history row (Chef's Larder lamb shanks).
 *
 * Safety:
 * - DRY RUN by default.
...
const SCRIPT_NAME = 'seed-chefs-larder-slow-cooked-lamb-shanks';
const RUN_MUTATION_ENV = 'RUN_SEED_CHEFS_LARDER_SLOW_COOKED_LAMB_SHANKS_MUTATION';
const ALLOW_MUTATION_ENV = 'ALLOW_SEED_CHEFS_LARDER_SLOW_COOKED_LAMB_SHANKS_MUTATION_SCRIPT';
const HARD_CAP = 10;
