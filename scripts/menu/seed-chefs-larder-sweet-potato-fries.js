...
/**
 * Seed a single menu ingredient + price history row (Chef's Larder sweet potato fries).
 *
 * Safety:
 * - DRY RUN by default.
...
const SCRIPT_NAME = 'seed-chefs-larder-sweet-potato-fries';
const RUN_MUTATION_ENV = 'RUN_SEED_CHEFS_LARDER_SWEET_POTATO_FRIES_MUTATION';
const ALLOW_MUTATION_ENV = 'ALLOW_SEED_CHEFS_LARDER_SWEET_POTATO_FRIES_MUTATION_SCRIPT';
const HARD_CAP = 10;
...
const rawFeatures = [
  ...
  'Freeze Chill',
  'Suitable for Vegetarians and Suitable for Vegans',
  'Pre-seasoned for a great flavour',
  'Gluten Free',
  'Deep fry 3 mins',
  '9mm straight cut fries',
  'Suitable for Coeliacs',
];
const rawLifestyleStatements = ['Suitable for Vegans', 'Suitable for Vegetarians', 'Suitable for Coeliacs'];
...
const ingredientPayload = {
  name: "Chef's Larder Premium Super Crisp Sweet Potato Gourmet Fries 2.5kg",
  description: 'Ready to Cook 9mm Straight Cut Sweet Potato Fries in Batter.',
  ...
  notes: [
    'Barcode: 5020379163026.',
    'Storage: Keep frozen at -18°C or below. Do not refreeze once defrosted.',
    'Cooking: Oven bake ~20 mins at 180°C/160°C fan or deep-fry for ~3 mins at 175°C.',
    'Ensure core temperature reaches 70°C before serving.',
  ].join(' '),
  is_active: true,
};
