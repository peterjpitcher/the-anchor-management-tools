/**
 * Creates the November guest round-up as a DRAFT, for the owner to read in the UI.
 *
 ...
 *
 * Dry run by default. RUN_NOVEMBER_ROUNDUP_DRAFT_MUTATION=true applies it.
 */
...
const CAMPAIGN_FILE = path.join(
  process.cwd(),
  'src/lib/email/marketing/campaigns/november-2026-whats-on-guests.json',
)
const OWNER_USER_ID = 'b44dd268-7c66-4163-8ff3-cc962b2d528c'
const CAMPAIGN_NAME = 'Welcome to November - guests - 2026'
const UTM_CAMPAIGN = 'november-2026-roundup-guests'
...
async function main(): Promise<void> {
  ...
  assertScriptMutationAllowed({
    scriptName: 'create-november-roundup-draft-2026',
    envVar: 'RUN_NOVEMBER_ROUNDUP_DRAFT_MUTATION',
  })
